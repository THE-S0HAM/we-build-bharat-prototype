...
/** Approval records authority for later execution; it does not execute. */
const PROCEED =
  "Approval recorded for later execution. This decision did not execute the action.";

const PROCEED_EDITED =
  "Your edited action was approved for later execution. This decision did not execute it.";

/** The generic decline outcome records only the decision state. */
const WILL_NOT_PROCEED = "Decline decision recorded. The action is not approved for execution.";
