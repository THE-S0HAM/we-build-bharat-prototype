 ...
 * - **A demo action.** It calls the backend's fixed restricted demo-session
 *   endpoint and never embeds an identity or credential in the browser.
    ...
    return (
      <main className="login">
        <div className="login__masthead">
          <h1 className="login__wordmark">CommunityOps</h1>
        </div>
        <section className="login__panel" aria-labelledby="login-heading">
          <h2 className="login__title" id="login-heading">Sign-in unavailable</h2>
          <p className="login__subtitle">
            CommunityOps authentication is not configured for this deployment. Contact the deployment administrator.
          </p>
        </section>
      </main>
    );
