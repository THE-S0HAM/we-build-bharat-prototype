...
function OrganizationAccessUnavailable() {
  ...
  return (
    <main className="page">
      ...
      <p>
        This account is not assigned to a CommunityOps organization. Contact your organization
        administrator, or sign out and use another account.
      </p>
