...
export const NAV_ITEMS: readonly NavItem[] = [
  ...
  { id: "budget", label: "Budget", path: "/budget", group: "governance", eventScoped: true },
  { id: "agent", label: "Agent", path: "/agent", group: "governance", eventScoped: true },
  { id: "audit-log", label: "Audit", path: "/audit", group: "governance", eventScoped: true },
];
