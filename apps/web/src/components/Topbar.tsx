 ...
 */
export function Topbar({ eventSwitcher, demoWorkspaceChip, role, pendingDecisions = 0, onSignOut }: TopbarProps) {
  ...
  return (
    <div className="topbar">
      ...
      <div className="topbar__session">
        {role ? <span className="topbar__role">{role === "LEADER" ? "Community leader" : "Team member"}</span> : null}
        {pendingDecisions > 0 ? <span className="topbar__decisions">{pendingDecisions} waiting</span> : null}
        {isMockMode ? (
